...
abstract class AbstractSearchIteratorCases extends TestCase
{
    ...
    public function test_it_throws_if_no_search_query_set(): void
    {
        ...
        $this->expectExceptionMessage(
            "You must call ".$subject::class."::setQuery() before iterating result"
        );
    ...
    abstract protected function newSubject(): AbstractSearchIterator;
